...
class ContactDetector(contactListener):
    ...
    def EndContact(self, contact):
        ...
        #         leg.ground_contact = False
            if leg in [contact.fixtureA.body, contact.fixtureB.body]:
                leg.ground_contact = True
                # Tạo hạt bụi tại vị trí chân
                self.env.create_particles(leg.position)
...
python
    ...
    def __init__(self, render_mode: Optional[str] = None, hardcore: bool = False):
        ...
        self.particles = []  # Lưu trữ các hạt bụi
    ...
    def create_particles(self, position):
        ...
        for _ in range(5):  # Tạo 5 hạt bụi
            particle = {
                'position': [position[0] * SCALE, position[1] * SCALE],
                'velocity': [np.random.uniform(-1, 1), np.random.uniform(-2, 0)],
                'lifetime': 30  # Hạt tồn tại trong 30 khung hình
            }
    ...
    def render(self):
        ...
        current_time = pygame.time.get_ticks() / 1000  # Thời gian tính bằng giây
        color = (
            int(135 + 120 * math.sin(current_time)),  # Thay đổi giá trị màu đỏ
            206,  # Giữ nguyên màu xanh lá cây
            int(235 - 120 * math.sin(current_time)),  # Thay đổi giá trị màu xanh dương
        )
        ...
        for particle in self.particles:
            ...
            # Vẽ hạt bụi (hình tròn nhỏ)
            pygame.draw.circle(
                self.surf,
                (250,0,0, max(0, particle['lifetime'] * 8)),  # Màu xám cho bụi
